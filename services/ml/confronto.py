...
from services.etl.agenda_fontes import clausula_para_jogo
from services.ml.modelos import SEMENTE

logger = logging.getLogger(__name__)

PASTA = BASE_DIR / "data" / "modelos"
...
def _preencher_saldo_placar(sessao, jogo: str, equipes: dict[int, Equipe]) -> None:
    ...
    """
    from services.etl.wikis import unidade_placar
