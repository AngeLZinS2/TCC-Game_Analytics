...
**Termos de uso.** Cada torneio e uma chamada `action=parse` (a pagina do
bracket inteira) - a Liquipedia trata isso a parte do limite geral de 2s:
"should not exceed 1 request per 30 seconds as these are more resource
intensive". O intervalo aqui (`liquipedia_parse_rate_limit_seconds`) e 35s,
com folga.
"""
...
from services.etl.transform_liquipedia import ResultadoAgenda
from services.etl.transform_liquipedia_bracket import ENDPOINT_BRACKET, FONTE, transformar
